...
/**
 * Superclass for all modeless dialogs. Remembers the last location, handles
 * escape, etc.
 */
public class EModelessDialog extends JFrame {
    ...
    /**
     * Method to complete initialization of a dialog. Restores the size from
     * last time.
     */
    ...
    /**
     * Method to ensure that the dialog is the proper size. It must be at least
     * as large as the user-specified size. However, it cannot grow to be larger
     * than the display.
     */
    ...
    /**
     * Method called when the ESCAPE key is pressed. Override it to cancel the
     * dialog.
     */
