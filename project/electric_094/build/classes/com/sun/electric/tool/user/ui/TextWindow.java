...
public class TextWindow implements WindowContent {
     ...
     */
    private TextWindowPanel overall;
    /**
     * true if text in the window is closing.
     */
    private boolean finishing;
    /**
     * true if text in the window is being reloaded.
     */
    ...
    /**
     * Factory method to create a new TextWindow with a given cell, in a given
     * WindowFrame.
     *
    ...
    /**
     * This dummy class duplicates JPanel but makes it recognizable as the
     * JPanel in a TextWindow.
     */
    ...
    private static class SaveCellText extends Job {
        ...
        public boolean doIt() throws JobException {
            if (cell != null) {
                cell.setTextViewContents(strings, getEditingPreferences());
            }
            return true;
        }
    }
    ...
    /**
     * Method to update text for a cell (if it is being displayed). This is
     * called when the text for a cell has been changed by some other part of
     * the system, and should be redisplayed where appropriate.
     *
...
//	public void cellHistoryGoForward() {}
    ...
    public boolean findNextText(boolean reverse) {
        ...
        if (reverse) {
            searchPoint = textArea.getSelectionStart();
        }
        try {
    ...
    public void replaceAllText(String replace) {
        ...
        for (int i = 0; i < lines; i++) {
            ...
            if (found) {
                textArea.replaceRange(theLine, startPos, endPos);
            }
        }
    }
