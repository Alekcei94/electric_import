...
public class SimulationTool extends Tool {
     ...
     * @param deckFile netlist file (null to use netlist in current cell, "" to
     * prompt user for file name).
     * @param prevCell the previous cell being simulated (null for a new
     * simulation).
     * @param prevEngine the previous simulation engine running (null for a new
     * simulation).
     */
    ...
    /**
     * Method to set the currently-selected signal undefined at the current
     * time.
     */
     ...
     *
     * @return the Engine that is running. Prints an error and returns null if
     * there is none.
     */
    ...
    /**
     * Method to set the type of the currently selected wires. This is used by
     * the Verilog netlister.
     *
    ...
    /**
     * Method to set the strength of the currently selected transistor. This is
     * used by the Verilog netlister.
     *
    ...
    /**
     * Method to tell whether FastHenry deck generation should use a single
     * frequency. The default is false.
     *
    ...
    /**
     * Method to set whether FastHenry deck generation should use a single
     * frequency.
     *
    ...
    /**
     * Method to return the FastHenry starting frequency (or only if using a
     * single frequency). The default is 0.
     *
     * @return the FastHenry starting frequency (or only if using a single
     * frequency).
     */
    ...
    /**
     * Method to set the FastHenry starting frequency (or only if using a single
     * frequency).
     *
     * @param s the FastHenry starting frequency (or only if using a single
     * frequency).
     */
    ...
    /**
     * Method to return the number of runs per decade for FastHenry deck
    ...
    /**
     * Method to set the number of runs per decade for FastHenry deck
     * generation.
     *
     ...
     *
     * @return the number of runs per decade for FastHenry deck generation, by
     * default.
     */
    ...
    /**
     * Method to tell whether FastHenry deck generation should make a multipole
     * subcircuit. The default is false.
     *
     * @return true if FastHenry deck generation should make a multipole
     * subcircuit.
     */
    ...
    /**
     * Method to set whether FastHenry deck generation should make a multipole
     * subcircuit.
     *
     * @param mp true if FastHenry deck generation should make a multipole
     * subcircuit.
     */
    ...
    /**
     * Method to return the number of poles for FastHenry deck generation. The
     * default is 20.
     *
    ...
    /**
     * Method to return the number of poles for FastHenry deck generation, by
     * default.
     *
    ...
    /**
     * Method to return the default number of width subdivisions for FastHenry
     * deck generation. The default is 1.
     *
     * @return the default number of width subdivisions for FastHenry deck
     * generation.
     */
    ...
    /**
     * Method to set the default number of width subdivisions for FastHenry deck
     * generation.
     *
     * @param w the default number of width subdivisions for FastHenry deck
     * generation.
     */
    ...
    /**
     * Method to return the default number of height subdivisions for FastHenry
     * deck generation. The default is 1.
     *
     * @return the default number of height subdivisions for FastHenry deck
     * generation.
     */
    ...
    /**
     * Method to set the default number of height subdivisions for FastHenry
     * deck generation.
     *
     * @param h the default number of height subdivisions for FastHenry deck
     * generation.
     */
    ...
    /**
     * Method to return the maximum segment length for FastHenry deck
     ...
     * generation, by default.
     *
     * @return the maximum segment length for FastHenry deck generation, by
     * default.
     */
     ...
     */
    /**
     * Method to tell whether Verilog deck generation should use the Assign
    ...
    public static boolean getVerilogUseAssign() {
        return getVerilogUseAssignSetting().getBoolean();
    }

    /**
     * Returns setting to tell whether Verilog deck generation should use the
     * Assign statement.
     *
     * @return setting to tell whether Verilog deck generation should use the
     * Assign statement.
     */
    ...
    /**
     * Method to tell whether Verilog deck generation should use Trireg by
     * default. The alternative is to use the "wire" statement. The default is
     * false.
     *
     * @return true if Verilog deck generation should use Trireg by default.
     */
    public static boolean getVerilogUseTrireg() {
        return getVerilogUseTriregSetting().getBoolean();
    }

    /**
     * Returns setting to tell whether Verilog deck generation should use Trireg
     * by default. The alternative is to use the "wire" statement.
     *
     * @return setting to tell whether Verilog deck generation should use Trireg
     * by default.
     */
    ...
    /**
     * Method to return the CDL library name. CDL is a weak form of a Spice
     * deck, and it includes a Cadence library name.
     *
    ...
    /**
     * Method to set the CDL library name. CDL is a weak form of a Spice deck,
     * and it includes a Cadence library name.
     *
    ...
    /**
     * Method to return the default CDL library name. CDL is a weak form of a
     * Spice deck, and it includes a Cadence library name.
     *
    ...
    /**
     * Method to return the CDL library path. CDL is a weak form of a Spice
     * deck, and it includes a Cadence library.
     *
    ...
    /**
     * Method to set the CDL library path. CDL is a weak form of a Spice deck,
     * and it includes a Cadence library.
     *
    ...
    /**
     * Method to return the default CDL library path. CDL is a weak form of a
     * Spice deck, and it includes a Cadence library.
     *
    ...
    /**
     * Method to tell whether CDL converts square bracket characters. CDL is a
     * weak form of a Spice deck, and it includes a Cadence library.
     *
    ...
    /**
     * Method to set if CDL converts square bracket characters. CDL is a weak
     * form of a Spice deck, and it includes a Cadence library.
     *
    ...
    /**
     * Method to tell whether built-in simulators resimulate after each change
     * to the display. When false, the user must request resimulation after a
     * set of changes is done.
     *
     * @return true if built-in simulators resimulate after each change to the
     * display.
     */
    ...
    /**
     * Method to set if built-in simulators resimulate after each change to the
     * display. When false, the user must request resimulation after a set of
     * changes is done.
     *
     * @param r true if built-in simulators resimulate after each change to the
     * display.
     */
    ...
    /**
     * Method to tell whether built-in simulators resimulate after each change
     * to the display, by default. When false, the user must request
     * resimulation after a set of changes is done.
     *
     * @return true if built-in simulators resimulate after each change to the
     * display, by default.
     */
    ...
    /**
     * Method to tell whether built-in simulators automatically advance the time
     * cursor when stimuli are added.
     *
     * @return true if built-in simulators automatically advance the time cursor
     * when stimuli are added.
     */
    ...
    /**
     * Method to set if built-in simulators automatically advance the time
     * cursor when stimuli are added.
     *
     * @param r true if built-in simulators automatically advance the time
     * cursor when stimuli are added.
     */
    ...
    /**
     * Method to tell whether built-in simulators automatically advance the time
     * cursor when stimuli are added, by default.
     *
     * @return true if built-in simulators automatically advance the time cursor
     * when stimuli are added, by default.
     */
     ...
     * Multi-state displays distinguish different strengths with different
     * colors in the waveform window, and use different colors to distinguish
     * different levels when drawing the cross-probing of the waveform in the
     * schematics and layout window. The default is false.
     *
    ...
    /**
     * Method to tell whether the waveform uses a multi-state display, by
     * default. Multi-state displays distinguish different strengths with
     * different colors in the waveform window, and use different colors to
     * distinguish different levels when drawing the cross-probing of the
     * waveform in the schematics and layout window.
     *
    ...
    /**
     * Method to tell whether IRSIM shows commands that are issued (for
     * debugging).
     *
     ...
     *
     * @return true if IRSIM shows commands that are issued (for debugging), by
     * default.
     */
    ...
    /**
     * Method to tell the debugging level for IRSIM simulation. This is a
     * combination of bits, where: Bit 1: debug event scheduling (Sim.DEBUG_EV)
     * Bit 2: debug final value computation (Sim.DEBUG_DC) Bit 3: debug
     * tau/delay computation (Sim.DEBUG_TAU) Bit 4: debug tauP computation
     * (Sim.DEBUG_TAUP) Bit 5: debug spike analysis (Sim.DEBUG_SPK) Bit 6: debug
     * tree walk (Sim.DEBUG_TW)
     *
    ...
    /**
     * Method to set the debugging level for IRSIM simulation. This is a
     * combination of bits, where: Bit 1: debug event scheduling (Sim.DEBUG_EV)
     * Bit 2: debug final value computation (Sim.DEBUG_DC) Bit 3: debug
     * tau/delay computation (Sim.DEBUG_TAU) Bit 4: debug tauP computation
     * (Sim.DEBUG_TAUP) Bit 5: debug spike analysis (Sim.DEBUG_SPK) Bit 6: debug
    ...
    /**
     * Method to tell the debugging level for IRSIM simulation, by default. This
     * is a combination of bits, where: Bit 1: debug event scheduling
     * (Sim.DEBUG_EV) Bit 2: debug final value computation (Sim.DEBUG_DC) Bit 3:
     * debug tau/delay computation (Sim.DEBUG_TAU) Bit 4: debug tauP computation
     * (Sim.DEBUG_TAUP) Bit 5: debug spike analysis (Sim.DEBUG_SPK) Bit 6: debug
     * tree walk (Sim.DEBUG_TW)
     *
    ...
    /**
     * Method to tell the stepping model to use for IRSIM. Possible choices are
     * "RC" (the default) and "Linear".
     *
    ...
    /**
     * Method to set the stepping model to use for IRSIM. Possible choices are
     * "RC" (the default) and "Linear".
     *
    ...
    /**
     * Method to tell the stepping model to use for IRSIM, by default. Possible
     * choices are "RC" and "Linear".
     *
    ...
    /**
     * Get whether or not IRSIM uses a delayed X model, versus the old
     * fast-propagating X model.
     *
     * @return true if using the delayed X model, false if using the old
     * fast-propagating X model.
     */
     ...
     * fast-propagating X model.
     *
     * @param b true to use the delayed X model, false to use the old
     * fast-propagating X model.
     */
    ...
    /**
     * Get whether or not IRSIM uses a delayed X model, versus the old
     * fast-propagating X model, by default.
     *
     * @return true if using the delayed X model, false if using the old
     * fast-propagating X model, by default.
     */
    ...
    /**
     * Method to tell which SPICE engine is being used. Since different versions
     * of SPICE have slightly different syntax, this is needed to tell the deck
     * generator which variation to target.
     *
     * @return which SPICE engine is being used. These constants are available:
     * <BR>
    ...
    /**
     * Method to set which SPICE engine is being used. Since different versions
     * of SPICE have slightly different syntax, this is needed to tell the deck
     * generator which variation to target.
     *
     * @param engine which SPICE engine is being used. These constants are
     * available: <BR>
     * SpiceEngine.SPICE_ENGINE_2 for Spice 2.<BR>
    ...
    /**
     * Method to tell which SPICE engine is being used, by default. Since
     * different versions of SPICE have slightly different syntax, this is
     * needed to tell the deck generator which variation to target.
     *
     * @return which SPICE engine is being used, by default. These constants are
     * available: <BR>
     * SpiceEngine.SPICE_ENGINE_2 for Spice 2.<BR>
     * SpiceEngine.SPICE_ENGINE_3 for Spice 3.<BR>
     * SpiceEngine.SPICE_ENGINE_H for HSpice.<BR>
    ...
    /**
     * Method to tell which SPICE level is being used. SPICE can use 3 different
    ...
    /**
     * Method to set which SPICE level is being used. SPICE can use 3 different
     * levels of simulation.
     *
    ...
    /**
     * Method to tell which SPICE level is being used, by default. SPICE can use
     ...
     * 1 for parasitic resistor shorting (normal resistors shorted, poly
     * resistors not shorted).<BR>
    ...
    /**
     * Method to tell how SPICE should short resistors, by default. These values
     * can be: <BR>
     * 0 for no resistor shorting.<BR>
     * 1 for parasitic resistor shorting (normal resistors shorted, poly
     * resistors not shorted).<BR>
    ...
    /**
     * Get whether or not to use the user-specified spice run directory, by
     * default
     */
    ...
    /**
     * Get whether or not we automatically overwrite the spice output file, by
     * default
     */
    ...
    /**
     * Method to get the Spice header card specification. Header cards can come
     * from one of three places, depending on the specification:<BR>
     * Specification="N O N E XXX" means use built-in header cards (XXX is the
     * former specification).<BR>
     * Specification="Extension XXX" means use header cards from the file
     * TOPCELL.XXX where TOPCELL is the name of the top-level cell name and XXX
     * is a specified extension.<BR>
    ...
    /**
     * Method to set the Spice header card specification. Header cards can come
     * from one of three places, depending on the specification:<BR>
     * Specification="N O N E XXX" means use built-in header cards (XXX is the
     * former specification).<BR>
     * Specification="Extension XXX" means use header cards from the file
    ...
    /**
     * Method to get the Spice header card specification, by default. Header
     * cards can come from one of three places, depending on the
     * specification:<BR>
     * Specification="N O N E XXX" means use built-in header cards (XXX is the
     * former specification).<BR>
     * Specification="Extension XXX" means use header cards from the file
    ...
    /**
     * Method to get the Spice trailer card specification. Trailer cards can
     * come from one of three places, depending on the specification:<BR>
     * Specification="N O N E XXX" means use built-in trailer cards (XXX is the
     * former specification).<BR>
     * Specification="Extension XXX" means use trailer cards from the file
     * TOPCELL.XXX where TOPCELL is the name of the top-level cell name and XXX
     * is a specified extension.<BR>
    ...
    /**
     * Method to set the Spice trailer card specification. Trailer cards can
     * come from one of three places, depending on the specification:<BR>
     * Specification="N O N E XXX" means use built-in trailer cards (XXX is the
     * former specification).<BR>
     * Specification="Extension XXX" means use trailer cards from the file
    ...
    /**
     * Method to get the Spice trailer card specification, by default. Trailer
     * cards can come from one of three places, depending on the
     * specification:<BR>
     * Specification="N O N E XXX" means use built-in trailer cards (XXX is the
     * former specification).<BR>
    ...
    public enum SpiceParasitics {
        /**
         * simple parasitics (source/drain area&perimeter)
         */
        SIMPLE(0, "Trans area/perim only"),
        /**
         * RC parasitics to substrate.
         */
        RC_CONSERVATIVE(1, "Conservative RC"),
        /**
         * RC parasitics to substrate or intervening layers.
         */
    ...
    /**
     * Method to tell the level of parasitics being used by Spice output. The
     * default is PARASITICS_SIMPLE.
     *
    ...
    /**
     * Method to tell the level of parasitics being used by Spice output, by
     * default.
     *
    ...
    public enum SpiceGlobal {
        ...
        USESUBCKTPORTS(2);
        /**
         * Write ports in .SUBCKT for global signals in Spice output.
         */
        private int code;
    ...
    /**
     * Method to tell how to treat globals in Spice output. Globals are signals
     * such as power and ground. The values can be:<BR>
     * SPICEGLOBALSNONE: no special treatment of globals<BR>
     * SPICEGLOBALSUSEGLOBALBLOCK: create a .GLOBAL block for globals (the
     * default)<BR>
     * SPICEGLOBALSUSESUBCKTPORTS: place globals as .SUBCKT parameters<BR>
     *
     * @return how to treat globals in Spice output.
     */
    public static SimulationTool.SpiceGlobal getSpiceGlobalTreatment() {
        return SpiceGlobal.find(cacheGlobalTreatment.getInt());
    }

    /**
     * Method to set how to treat globals in Spice output. Globals are signals
     * such as power and ground. The values can be:<BR>
     * SPICEGLOBALSNONE: no special treatment of globals<BR>
     ...
     */
    public static void setSpiceGlobalTreatment(SimulationTool.SpiceGlobal g) {
        cacheGlobalTreatment.setInt(g.getCode());
    }

    /**
     * Method to tell how to treat globals in Spice output, by default. Globals
     * are signals such as power and ground. The values can be:<BR>
     * SPICEGLOBALSNONE: no special treatment of globals<BR>
     * SPICEGLOBALSUSEGLOBALBLOCK: create a .GLOBAL block for globals (the
     * default)<BR>
     * SPICEGLOBALSUSESUBCKTPORTS: place globals as .SUBCKT parameters<BR>
     ...
     */
    public static SimulationTool.SpiceGlobal getFactorySpiceGlobalTreatment() {
    ...
    /**
     * Method to tell whether or not to write power and ground in Spice top cell
     * section. The default is true. True is the default behavior until now.
     *
    ...
    /**
     * Method to set whether or not to write power and ground in Spice top cell
     * section.
     *
     ...
     * When cell parameters are used, any parameterized cell is written many
     * times, once for each combination of parameter values. The default is
     * false.
     *
    ...
    /**
     * Method to set whether or not to use cell parameters in Spice output. When
     * cell parameters are used, any parameterized cell is written many times,
    ...
    /**
     * Method to tell whether or not to use cell parameters in Spice output, by
     * default. When cell parameters are used, any parameterized cell is written
     * many times, once for each combination of parameter values.
     *
    ...
    /**
     * Method to tell whether or not to write transistor sizes in "lambda" grid
     * units in Spice output. Lambda grid units are the basic units of design.
     * When writing in these units, the values are simpler, but an overriding
     * scale factor brings them to the proper size. The default is false.
     *
     * @return true to write transistor sizes in "lambda" grid units in Spice
     * output.
     */
    ...
    /**
     * Method to set whether or not to write transistor sizes in "lambda" grid
     * units in Spice output. Lambda grid units are the basic units of design.
     * When writing in these units, the values are simpler, but an overriding
     * scale factor brings them to the proper size.
     *
     * @param l true to write transistor sizes in "lambda" grid units in Spice
     * output.
     */
    ...
    /**
     * Method to tell whether or not to write transistor sizes in "lambda" grid
     * units in Spice output, by default. Lambda grid units are the basic units
     * of design. When writing in these units, the values are simpler, but an
     * overriding scale factor brings them to the proper size.
     *
     * @return true to write transistor sizes in "lambda" grid units in Spice
     * output, by default.
     */
    ...
    /**
     * Get whether or not we automatically place cell contents after importing
     * Spice decks
     */
    ...
    /**
     * Set whether or not we automatically place cell contents after importing
     * Spice decks
     */
