    ...
    static EMenu makeMenu() {
        ...
        return new EMenu("_Edit",
            ...
            public void run() {
                ...
                new EMenuItem("Sho_w Undo List") {
            public void run() {
                showUndoListCommand();
            }
        },
                new EMenuItem("Repeat Last Action", KeyStroke.getKeyStroke(KeyEvent.VK_F7, 0)) {
            public void run() {
                ...
                new EMenu("_Rotate",
                        new EMenuItem("90 Degrees Clock_wise") {
                    public void run() {
                ...
                new EMenu("Si_ze",
                        new EMenuItem("_Interactively", 'B') {
                    public void run() {
                ...
                new EMenu("Mo_ve",
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Move Objects Left", KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, 0)) {
                    public void run() {
                        ClickZoomWireListener.moveSelected(-1, 0, false, false);
                    }
                },
                        new EMenuItem("Move Objects Right", KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, 0)) {
                    public void run() {
                        ClickZoomWireListener.moveSelected(1, 0, false, false);
                    }
                },
                        new EMenuItem("Move Objects Up", KeyStroke.getKeyStroke(KeyEvent.VK_UP, 0)) {
                    public void run() {
                        ClickZoomWireListener.moveSelected(0, 1, false, false);
                    }
                },
                        new EMenuItem("Move Objects Down", KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, 0)) {
                    public void run() {
                        ClickZoomWireListener.moveSelected(0, -1, false, false);
                    }
                },
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Move Objects Most Left", KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, ctrlShift)) {
                    public void run() {
                        ClickZoomWireListener.moveSelected(-1, 0, true, true);
                    }
                },
                        new EMenuItem("Move Objects Most Right", KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, ctrlShift)) {
                    public void run() {
                        ClickZoomWireListener.moveSelected(1, 0, true, true);
                    }
                },
                        new EMenuItem("Move Objects Most Up", KeyStroke.getKeyStroke(KeyEvent.VK_UP, ctrlShift)) {
                    public void run() {
                        ClickZoomWireListener.moveSelected(0, 1, true, true);
                    }
                },
                        new EMenuItem("Move Objects Most Down", KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, ctrlShift)) {
                    public void run() {
                        ClickZoomWireListener.moveSelected(0, -1, true, true);
                    }
                },
                        SEPARATOR,
                        new EMenuItem("Align Horizontally to _Left") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Align Vertically to _Top") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Cell Center to Center of Selection") {
                    public void run() {
                ...
                new EMenuItem("_Array...", KeyStroke.getKeyStroke(KeyEvent.VK_F6, 0)) {
            public void run() {
                Array.showArrayDialog();
            }
        },
                new EMenuItem("C_hange...", KeyStroke.getKeyStroke('C', 0)) {
            public void run() {
                ...
                new EMenu("Propert_ies",
                        new EMenuItem("_Object Properties...", 'I') {
                    public void run() {
                        getInfoCommand(false);
                    }
                },
                        SEPARATOR,
                        new EMenuItem("Cell _Parameters...") {
                    public void run() {
                        Attributes.showDialog();
                    }
                },
                        new EMenuItem("Update Parameters on _Node") {
                    public void run() {
                        updateParameters(false);
                    }
                },
                        new EMenuItem("Update Parameters all _Libraries") {
                    public void run() {
                        updateParameters(true);
                    }
                },
                        SEPARATOR,
                        new EMenuItem("Parameterize _Bus Name") {
                    public void run() {
                ...
                new EMenu("Ar_c",
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Toggle _Directionality") {
                    public void run() {
                        CircuitChanges.arcDirectionalCommand();
                    }
                },
                        new EMenuItem("Toggle End Extension _of Both Head/Tail") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Insert _Jog In Arc") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        new EMenuItem("Connect Arcs that Cross Named Networ_k...") {
                    public void run() {
                        CircuitChanges.connectOverlappingNetworks();
                    }
                },
                        SEPARATOR,
                        new EMenuItem("_Curve through Cursor") {
                    public void run() {
                ...
                new EMenu("Te_xt",
                    ...
                    public void run() {
                        ...
                        new EMenuItem("Add _Text Annotation", KeyStroke.getKeyStroke('T', 0)) {
                    public void run() {
                        PaletteFrame.placeInstance("ART_message", null, false);
                    }
                },
                        new EMenuItem("Add _GDS Text") {
                    public void run() {
                        addGDSText(false);
                    }
                },
                        new EMenuItem("Add _HV GDS Text") {
                    public void run() {
                        addGDSText(true);
                    }
                },
                        new EMenuItem("Edit Text Cell _Externally...") {
                    public void run() {
                ...
                new EMenu("Clea_nup Cell",
                    ...
                    public void run() {
                        ...
                        new EMenuItem("Show _Redundant Pure-Layer Nodes") {
                    public void run() {
                ...
                new EMenu("Technology Speci_fic",
                        new EMenuItem("Toggle Port _Negation", 'T') {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Descri_be this Technology") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        new EMenuItem("Write XML of Current Technology...") {
                    public void run() {
...
//                    }
                        ...
                        new EMenuItem("Write XML of Technology from Old Electric Build...") {
                    public void run() {
                        ...
                        new EMenu("_FPGA",
                                new EMenuItem("Read _Architecture And Primitives...") {
                            public void run() {
                            ...
                            public void run() {
                                ...
                                SEPARATOR,
                                new EMenuItem("Edit _Pips...") {
                            public void run() {
                                FPGA.tech().programPips();
                            }
                        },
                                SEPARATOR,
                                new EMenuItem("Show _No Wires") {
                            public void run() {
                ...
                new EMenu("Technolo_gy Editing",
                        new EMenuItem("Convert Technology to _Library for Editing...") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("_Identify Primitive Layers") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Edit Library _Dependencies...") {
                    public void run() {
                        Manipulate.editLibraryDependencies();
                    }
                },
                        new EMenuItem("Edit _Component Menu...") {
                    public void run() {
                        Manipulate.editComponentMenu();
                    }
                },
                        SEPARATOR,
                        new EMenuItem("Technology Creation _Wizard...") {
                    public void run() {
                ...
                new EMenu("_Selection",
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Select All Like _This") {
                    public void run() {
                        selectAllLikeThisCommand();
                    }
                },
                        new EMenuItem("Select _Next Like This" /*, '\t', KeyEvent.VK_TAB */) {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Select O_bject...") {
                    public void run() {
                        SelectObject.selectObjectDialog(null, false);
                    }
                },
                        new EMenuItem("Select Object Unde_r Cursor...", KeyStroke.getKeyStroke('U', 0)) {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Ma_ke Selected Easy") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Enclosed Ob_jects") {
                    public void run() {
                        selectEnclosedObjectsCommand();
                    }
                },
                        SEPARATOR,
                        new EMenuItem("Show Ne_xt Error", KeyStroke.getKeyStroke('>')) {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        new EMenuItem("Show Next Error, _same Window", KeyStroke.getKeyStroke(']')) {
                    public void run() {
                        showNextErrorCommand(false);
                    }
                },
                        new EMenuItem("Show Previous Error, sa_me Window", KeyStroke.getKeyStroke('[')) {
                    public void run() {
                        showPrevErrorCommand(false);
                    }
                },
                        new EMenuItem("Show Single Geometr_y", KeyStroke.getKeyStroke(KeyEvent.VK_SLASH, 0)) {
                    public void run() {
                        showSingleGeometryCommand();
                    }
                },
                        new EMenuItem("Show Current Co_llection of Errors") {
                    public void run() {
                        ErrorLoggerTree.showCurrentErrors();
                    }
                },
                        SEPARATOR,
                        new EMenuItem("Add to Waveform _in New Panel", KeyStroke.getKeyStroke('A', 0)) {
                    public void run() {
                        addToWaveformNewCommand();
                    }
                },
                        new EMenuItem("Add to _Waveform in Current Panel", KeyStroke.getKeyStroke('O', 0)) {
                    public void run() {
                        addToWaveformCurrentCommand();
                    }
                },
                        new EMenuItem("Remove _from Waveform", KeyStroke.getKeyStroke('R', 0)) {
                    public void run() {
    ...
    /**
     * This method implements the command to show the Key Bindings Options
     * dialog.
     */
    ...
    /**
     * This method shows the GetInfo dialog for the highlighted nodes, arcs,
     * and/or text.
     */
...
//	}
    ...
    private static class UpdateParameters extends Job {
         ...
         * @param allLibraries if true, update all nodeinsts in all libraries,
         * otherwise update highlighted
         */
    ...
    /**
     * This method implements the command to highlight all objects in the
     * current Cell.
     */
    ...
    /**
     * This method implements the command to highlight all objects in the
     * current Cell that are easy to select.
     */
    ...
    /**
     * This method implements the command to highlight all objects in the
     * current Cell that are hard to select.
     */
    ...
    private static void doSelection(boolean mustBeEasy, boolean mustBeHard) {
        ...
        for (Iterator<NodeInst> it = curCell.getNodes(); it.hasNext();) {
            ...
            if (thisPageBounds != null) {
                if (!thisPageBounds.contains(ni.getAnchorCenter())) {
                    continue;
                }
            }

            // "select all" should not include the cell-center
            if (Generic.isCellCenter(ni) && !mustBeEasy && !mustBeHard) {
                continue;
            }
            ...
            if (mustBeHard && !hard && !ni.isInvisiblePinWithText()) {
                continue;
            }
            ...
            if (ni.isInvisiblePinWithText() && mustBeHard && !hard) {
                continue;
            }
        ...
        for (Iterator<ArcInst> it = curCell.getArcs(); it.hasNext();) {
            ...
            // for multipage schematics, restrict to current page
            if (thisPageBounds != null) {
                if (!thisPageBounds.contains(ai.getHeadLocation())) {
                    continue;
                }
            }
        ...
        if (User.isTextVisibilityOnCell()) {
            for (Iterator<Variable> it = curCell.getParametersAndVariables(); it.hasNext();) {
                ...
                if (var.isAttribute()) {
                    // for multipage schematics, restrict to current page
                    if (thisPageBounds != null) {
                        if (!thisPageBounds.contains(new Point2D.Double(var.getXOff(), var.getYOff()))) {
                            continue;
                        }
                    }
    ...
    /**
     * This method implements the command to highlight all objects in the
     * current Cell that are like the currently selected object.
     */
    public static void selectAllLikeThisCommand() {
        ...
        for (Iterator<Export> it = curCell.getExports(); it.hasNext();) {
            Export e = it.next();
            PortCharacteristic pc = e.getCharacteristic();
            if (!likeThis.contains(pc.getName())) {
                continue;
            }
    ...
    /**
     * Method to select the next object that is of the same type as the current
     * object.
     */
    public static void selectNextLikeThisCommand(boolean next) {
        ...
        if (high.isHighlightEOBJ()) {
            ...
            if (eObj instanceof NodeInst) {
                ...
                for (Iterator<NodeInst> it = curCell.getNodes(); it.hasNext();) {
                    NodeInst ni = it.next();
                    if (ni.getProto() != thisNi.getProto()) {
                        continue;
                    }
                    if (ni == thisNi) {
                        which = tot;
            ...
            if (eObj instanceof ArcInst) {
                ...
                for (Iterator<ArcInst> it = curCell.getArcs(); it.hasNext();) {
                    ArcInst ai = it.next();
                    if (ai.getProto() != thisAi.getProto()) {
                        continue;
                    }
                    if (ai == thisAi) {
                        which = tot;
        ...
        if (high.isHighlightText()) {
            if (eObj instanceof Export) {
                ...
                for (Iterator<Export> it = curCell.getExports(); it.hasNext();) {
                    ...
                    if (e == eObj) {
                        which = allExports.size();
                    }
                    allExports.add(e);
                }
                if (next) {
                    which++;
                    if (which >= allExports.size()) {
                        which = 0;
                    }
                } else {
                    which--;
                    if (which < 0) {
                        which = allExports.size() - 1;
                    }
                }
                highlighter.clear();
                ...
                for (Iterator<ArcInst> it = curCell.getArcs(); it.hasNext();) {
                    ...
                    for (Iterator<Variable> vIt = ai.getVariables(); vIt.hasNext();) {
                        Variable var = vIt.next();
                        if (var.getKey() != high.getVarKey()) {
                            continue;
                        }
                        if (ai == high.getElectricObject() && var.getKey() == high.getVarKey()) {
                            which = allVarKeys.size();
                        }
                ...
                for (Iterator<NodeInst> it = curCell.getNodes(); it.hasNext();) {
                    ...
                    for (Iterator<Variable> vIt = ni.getParametersAndVariables(); vIt.hasNext();) {
                        ...
                        if (ni == high.getElectricObject() && var.getKey() == high.getVarKey()) {
                            which = allVarKeys.size();
                        }
                        allVarKeys.add(var.getKey());
                        allVarObjs.add(ni);
                ...
                for (Iterator<Variable> vIt = curCell.getVariables(); vIt.hasNext();) {
                    ...
                    if (curCell == high.getElectricObject() && var.getKey() == high.getVarKey()) {
                        which = allVarKeys.size();
                    }
                    allVarKeys.add(var.getKey());
                ...
                if (next) {
                    which++;
                    if (which >= allVarKeys.size()) {
                        which = 0;
                    }
                } else {
                    which--;
                    if (which < 0) {
                        which = allVarKeys.size() - 1;
                    }
                }
                highlighter.clear();
    ...
    /**
     * Command to popup a list of objects under the cursor and let the user
     * choose one to select.
     */
    ...
    /**
     * This method implements the command to highlight nothing in the current
     * Cell.
     */
    ...
    public static void deselectAllArcsCommand() {
        ...
        for (Highlight h : highlighter.getHighlights()) {
            if (h.isHighlightEOBJ() || h.isHighlightText()) {
                if (h.getElectricObject() instanceof ArcInst) {
                    continue;
                }
            }
            newHighList.add(h);
    ...
    /**
     * This method implements the command to make all selected objects be
     * easy-to-select.
     */
    ...
    /**
     * This method implements the command to show the next logged error. The
     * error log lists the results of the latest command (DRC, NCC, etc.)
     *
     * @param separateWindow true to show each cell in its own window; false to
    ...
    /**
     * This method implements the command to iterate along geometries found in
     * the current MessageLog The error log lists the results of the latest
     * command (DRC, NCC, etc.)
     */
    ...
    /**
     * This method implements the command to show the last logged error. The
     * error log lists the results of the latest command (DRC, NCC, etc.)
     *
     * @param separateWindow true to show each cell in its own window; false to
     * show in the current window.
    ...
    /**
     * This method implements the command to remove the currently selected
     * network from the waveform window.
     */
    ...
    public static void describeTechnologyCommand() {
        ...
        for (Iterator<PrimitiveNode> it = tech.getNodes(); it.hasNext();) {
            ...
            if (fun.isPin()) {
                pinCount++;
            } else if (fun.isContact() || fun == PrimitiveNode.Function.CONNECT) {
                contactCount++;
