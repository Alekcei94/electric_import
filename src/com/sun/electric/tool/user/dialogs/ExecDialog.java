...
public class ExecDialog extends EDialog implements Exec.FinishedListener {
    ...
    public synchronized void startProcess(String command, String[] envVars, File dir) {
        ...
        errStream = new ProcessOutput(outputErrorTextArea);
    ...
    private void initComponents() {
        ...
        outputErrorTextArea = new javax.swing.JTextArea();
        ...
        mainPanel.setPreferredSize(new java.awt.Dimension(700, 478));
        ...
        outputErrorTextArea.setColumns(40);
        outputErrorTextArea.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        outputErrorTextArea.setRows(20);
        jScrollPane2.setViewportView(outputErrorTextArea);
    ...
    private javax.swing.JTextArea outputErrorTextArea;
